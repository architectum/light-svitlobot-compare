        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Слідкуйте за станом електроенергії навколо і порівнюйте реальні відключення на вкладці "Порівняти відключення" або на сторінці деталей локації. Щоб отримати актуальні дані зі СвітлоБотів за різними адресами натисніть "Оновити Всі", або "Сканувати" на сторінці деталей локації.
            </p>
          </div>
